...
/*
    ...
    Rhombus rhombus(5, '+');
    Canvas rh{ rhombus.draw() };
    cout << rh << endl;

    AcuteTriangle acuteTriangle(5, '=');
...
void drawHouse()
{
    ...
    shapeVec.push_back(std::make_unique<Rectangle>(5, 1, '|', "left chimney edge"));
    Canvas chimneyL = shapeVec.back()->draw();
    houseCanvas.overlap(chimneyL, 14, 12);

    shapeVec.push_back(std::make_unique<Rectangle>(4, 1, '|', "right chimney edge"));
